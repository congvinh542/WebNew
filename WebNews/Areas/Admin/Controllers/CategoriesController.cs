...
namespace WebNews.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(WebNewsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CatId,CatName,Title,Alias,MetaDec,MetaKey,Thumb,Published,Odering,Parent,Levels,Icon,Cover,Description")] Category category, Microsoft.AspNetCore.Http.IFormFile fThumb, Microsoft.AspNetCore.Http.IFormFile fCover, Microsoft.AspNetCore.Http.IFormFile fIcon)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CatId"] = new SelectList(_context.Posts, "PostId", "PostId", category.CatId);
            return View(category);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatId,CatName,Title,Alias,MetaDec,MetaKey,Thumb,Published,Odering,Parent,Levels,Icon,Cover,Description")] Category category, Microsoft.AspNetCore.Http.IFormFile fThumb, Microsoft.AspNetCore.Http.IFormFile fCover, Microsoft.AspNetCore.Http.IFormFile fIcon)
        {
